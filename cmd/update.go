...
// update self-updates the meta-ad-library-cli binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/meta-ads-library-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update meta-ad-library-cli to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "meta-ad-library-cli-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "meta-ad-library-cli")
